...
Matrix::Matrix(int rows, int columns) : Matrix() {
...
Matrix::Matrix(const Matrix &mtx) : Matrix() {
...
void Matrix::zeros() { memset(matrix, 0.0f, n * m * sizeof(float)); }

int Matrix::getSize() const { return n * m; }

int Matrix::getRows() { return n; }

int Matrix::getColumns() { return m; }
